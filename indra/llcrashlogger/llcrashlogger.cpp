...
void LLCrashLogger::gatherFiles()
{
	...
	mFileMap.erase( "SecondLifeLog" ); // <FS:ND/> Don't send any Starbird.log. It's likely huge and won't help for crashdump processing.
...
#if ADDRESS_SIZE == 64
	gDirUtilp->initAppDirs( "Starbird_x64" );
#else
	gDirUtilp->initAppDirs("Starbird");
#endif
